...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute() {
        return GatewayRouterFunctions
                ...
                .route(RequestPredicates.path("/product/v3/api-docs"), HandlerFunctions.http())
                .before(BeforeFilterFunctions.uri("http://localhost:8080"))
                .build();
    ...
    public RouterFunction<ServerResponse> inventoryServiceRoute() {
        return GatewayRouterFunctions
                ...
                .route(RequestPredicates.path("/inventory/v3/api-docs"), HandlerFunctions.http())
                .before(BeforeFilterFunctions.uri("http://localhost:8082"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> orderServiceRoute() {
        return GatewayRouterFunctions
                ...
                .route(RequestPredicates.path("/order/v3/api-docs"), HandlerFunctions.http())
                .before(BeforeFilterFunctions.uri("http://localhost:8081"))
                .build();
    }
}
